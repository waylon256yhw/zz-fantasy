...
const WelcomeScreen: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-[#E6F3F5]">
      {/* Background Layer */}
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center p-8">
        ...
        >
          {/* Decorative Stars */}
          <Star className="absolute -top-8 -left-12 text-jrpg-accent w-12 h-12 animate-spin-slow drop-shadow-md" fill="#FFD166" />
          <Star className="absolute -bottom-4 -right-12 text-jrpg-primary w-8 h-8 animate-bounce drop-shadow-md" fill="#FF9FAA" />

          <h2 className="text-xl md:text-2xl font-bold text-jrpg-secondary mb-2 tracking-[0.3em] uppercase drop-shadow-sm">
            Project Aetheria
          </h2>
          <h1 className="text-6xl md:text-8xl font-serif font-black text-jrpg-text drop-shadow-md tracking-wide">
            艾瑟瑞亚
          </h1>
          <h3 className="text-2xl md:text-3xl font-serif text-jrpg-text/80 mt-2 font-bold drop-shadow-sm">
            ~ 编年史 ~
          </h3>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-4xl items-center">
          ...
          <motion.div 
            ...
            className="flex flex-col gap-4 w-full max-w-xs mx-auto md:mx-0"
          >
